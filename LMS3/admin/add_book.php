...
<body  style="background-color: #28282B; color:white; font-family: Andale Mono,monospace;">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="pading-bottom: 20px;">
	...
	<div class="container" style="background-color: #37474F; padding: 20px; border-radius: 10px;
            box-shadow: 0px 0px 15px 0px rgba(0, 0, 0, 2);height:600px;widht: 300px;">
